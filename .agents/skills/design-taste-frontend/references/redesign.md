...
* **Greenfield** - no existing site, or full overhaul approved. Dial baseline from Section 1 (in `SKILL.md`).
...
* **Extract brand colors before applying Section 4.2 (in `references/directives.md`).** A brand that is already purple stays purple - apply the LILA RULE's override.
...
5. **Hero & key-section recomposition** - restructure top-of-funnel using Section 10 (in `references/vocabulary.md`) vocabulary.

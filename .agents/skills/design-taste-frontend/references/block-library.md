...
The Reference Vocabulary (Section 10 (in `references/vocabulary.md`)) names patterns. The Block Library implements them with real props, real motion specs, and real code sketches.
...
* Every block must pass the Pre-Flight Check (Section 14 (in `references/preflight.md`)).
* Blocks that depend on a design system from Section 2.A (in `SKILL.md`) live under `blocks/<category>/<name>--<system>.md` (e.g. `feature/bento-grid--material.md`).

...
* SVG icons from libraries: fine (see Section 3.C (in `references/architecture.md`)).
...
* **No em-dashes inside the quote text** as design flourish (long pauses, kinetic em-dashes, em-dash-bullets). See Section 9.G (in `references/ai-tells.md`) - em-dash is completely banned.
